...
public:
  ...
  /// </param>
  /// <param name="points">
  /// The asociated bias will be 1 for all points.
  /// </param>
  /// <returns>
  /// True if successful
  /// </returns>
  ...
  /// <param name="biases">
  /// If biases is not nullptr, it must point to an array of point_count 
  /// doubles. The points will have the bias applied in the ChamferDistance()
  /// and PairingDeviation() evaluations. Typically bias values &gt;= 1
  /// and are employed when the PairingDeviation() is used as part of an
...
private:
  ...
  ON_SimpleArray<double> m_biases[2];
