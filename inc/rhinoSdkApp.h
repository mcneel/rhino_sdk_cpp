 ...
 */
  ...
  */  
  ...
  RHINO_SDK_FUNCTION
  void Wait( DWORD dwMilliseconds = 0);
 ...
 RHINO_SDK_FUNCTION
  ...
  // Obsolete use CRhinoApp::GetRhSkin()
  RHINO_SDK_FUNCTION
  class CRhSkin& RhSkin() const;

  RHINO_SDK_FUNCTION
  class CRhSkin* GetRhSkin() const;
  ...
  // Returns 
  //   true if Rhino is compiled as pre-release build
  //   false otherwise
  RHINO_SDK_FUNCTION
  bool IsPreRelease();
...
public:
  ...
  */
  ...
  RHINO_SDK_FUNCTION bool FileReference(ON_wString& FileName, bool bUseDialog = true, HWND hWndParent = nullptr);
...
protected:
  ...
  class CRhWorkSession*         m_DO_NOT_USE    = nullptr;
