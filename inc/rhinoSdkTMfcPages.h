...
///////////////////////////////////////////////////////////////////////////////
// Description:
//  CDialog Implementation of IRhinoWindow.
//  BASECLASS must be a class derived from CDialog.
//  If RHINO_SDK_MFC is defined, use CRhinoDialog as your base class.
...
public:
  ...
  AFX_MODULE_STATE* DialogModuleState() const
  {
    return BASECLASS::m_pModuleState;
  }
...
#pragma region IRhinoWindow overrides
  ...
  bool Destroy() override
  {
    MFC_DIALOG_MODULE_STATE;
    HWND hWnd = Handle();
    return ::IsWindow(hWnd) && ::DestroyWindow(hWnd);
  }
