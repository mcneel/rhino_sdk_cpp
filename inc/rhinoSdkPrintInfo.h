...
class RHINO_SDK_CLASS CRhinoPrintPageDefinition
{
public:
...
private:
  class CRhPrintPageDefinition* m_private = nullptr;
};
...
public:
  ...
  static void GetCustomPdfPages(ON_ClassArray<CRhinoPrintPageDefinition>& pages);
  static void SetCustomPdfPages(const ON_ClassArray<CRhinoPrintPageDefinition>& pages);
private:
