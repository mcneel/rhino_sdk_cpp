...
public:
  ...
  */
  ...
  /*
    ...
    Parameters:
      count [in] - number of cv's to use in deformable surfaces, should be bigger than degree
      degree [in] - the degree of the deformable surface, valid range is from 1 to 11
    Returns:
      @untitled table
  ...
  */
  ...
  void SetDeformableDegree(int degree);
...
/*
  Description:
    ...
    Parameters:
      ...
      bDeformable - if true a deformable revolve is build using degree and pointcount
      pointcount - deformable point count, should be bigger than degree
    Returns:
...
/*
  Description:
    ...
    Parameters:
      ...
      bDeformable - if true a deformable revolve is build using degree and pointcount
      pointcount - deformable point count, should be bigger than degree
      degree - deformable degree, valid range is from 1 to 11
    Returns:
      Pointer to the Revolved surface or NULL on error
*/
RHINO_SDK_FUNCTION
