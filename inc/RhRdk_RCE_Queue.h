...
public:
	...
	*/
	...
	public:
		...
		RDK_DEPRECATED MeshInstance(const CInstanceAncestry& a, const ON_Xform& xformInstance, ON__UINT32 materialCacheCRC, bool receiveShadows, bool castShadows, CRhRdkDecalIterator*);
		MeshInstance(const CInstanceAncestry& a, const ON_Xform& xformInstance, ON__UINT32 materialCacheCRC, bool receiveShadows, bool castShadows, CRhRdkDecalIteratorEx*);
		...
		const CRhRdkDecalIteratorEx* DecalIteratorEx(void) const;
...
protected:
	...
	RDK_DEPRECATED void PostMeshInstanceAdded(const CInstanceAncestry& uuidHistory, const ON__UINT32& materialId, const ON_Xform& instanceXForm, const ON_Xform& ocsXform, bool bCastShadows, bool bReceiveShadows, CRhRdkDecalIterator*);
	virtual_su void PostMeshInstanceAdded(const CInstanceAncestry& uuidHistory, const ON__UINT32& materialId, const ON_Xform& instanceXForm, const ON_Xform& ocsXform, bool bCastShadows, bool bReceiveShadows, CRhRdkDecalIteratorEx*);
