...
public:
  ...
  bool SaveProfileString(const wchar_t* lpszSection, const wchar_t* lpszEntry, const ON_ClassArray<ON_wString>& sValues) const;
  ...
  bool LoadProfileMultiString(const wchar_t* lpszSection, const wchar_t* lpszEntry, ON_ClassArray<ON_wString>& value) const;
