...
public:
  ...
  */
  ...
  void UpdateFileWriteOptionsFromIOSettings(CRhinoFileWriteOptions& fwo) const;
  void UpdateIOSettingsFromFileWriteOptions(const CRhinoFileWriteOptions& fwo); //Calls SetIOSettings
  ...
  */
  ...
  int NamedConstructionPlaneCount() const;
...
private:
  ...
  friend class CRhinoDocPropertiesUndoEventHandler;
  void ScaleProperties(bool model, const ON_UnitSystem& from, const ON_UnitSystem& to, bool undo = false);
