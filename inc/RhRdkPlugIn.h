...
RDK_DEPRECATED RHRDK_SDK CRhRdkTexture* RhRdkNewDibTexture(std::shared_ptr<CRhinoDib> pDib, const CRhinoDoc* pDocAssoc, bool bAllowSimulation = true);

RHRDK_SDK CRhRdkTexture* RhRdkNewDibTexture(std::shared_ptr<const CRhinoDib> pDib, const CRhinoDoc* pDocAssoc, bool bAllowSimulation = true);
