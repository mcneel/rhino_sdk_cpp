...
public:
  ...
  // Or call GetViewports that asks for multiple viewports one by one, and 
  // returns them in viewport_ids.
  CRhinoGet::result GetViewports(ON_SimpleArray<ON_UUID>& viewport_ids);
