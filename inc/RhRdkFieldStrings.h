...
#define FS_MAT_GEM_TYPE                           L"type"
  ...
  #define FS_MAT_GEM_TYPE_BLUE_SAPPHIRE             L"sapphire"
  #define FS_MAT_GEM_TYPE_CARNELIAN                 L"carnelian"
  #define FS_MAT_GEM_TYPE_DIAMOND                   L"diamond"
  #define FS_MAT_GEM_TYPE_EMERALD                   L"emerald"
  #define FS_MAT_GEM_TYPE_PERIDOT                   L"peridot"
  #define FS_MAT_GEM_TYPE_PINK_SAPPHIRE             L"pink-sapphire"
  #define FS_MAT_GEM_TYPE_RUBY                      L"ruby"
  #define FS_MAT_GEM_TYPE_SMOKY_QUARTZ              L"smoky-quartz"
  #define FS_MAT_GEM_TYPE_YELLOW_DIAMOND            L"yellow-diamond"
