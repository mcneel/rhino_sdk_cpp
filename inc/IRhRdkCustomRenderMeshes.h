	...
	namespace CustomRenderMeshes
	{
		...
		public:
			...
			public:
				...
				static std::shared_ptr<IInstance> New(
					std::shared_ptr<const ON_Mesh> mesh,
					const IInstance& previous, bool copy_material);
				...
				static std::shared_ptr<IInstance> New(std::shared_ptr<const ON_Mesh> mesh, const CRhinoObject&, bool use_material);
			};
		...
		class RHRDK_SDK IRenderMeshProvider2 : public IRenderMeshProvider
		{
		public:
			virtual bool HasCustomRenderMeshes2(
				ON::mesh_type mt,
				const ON_Viewport& vp,
				const CRhinoDoc& doc,
				const ObjectId& objectId,
			...
			virtual std::shared_ptr<const IRenderMeshes> RenderMeshes2(
				ON::mesh_type mt,
				const ON_Viewport& vp,
				const CRhinoDoc& doc,
				const ObjectId& objectId,
		...
		class RHRDK_SDK IManager2 : public IManager
		{
		public:
			virtual bool HasCustomRenderMeshes2(
				ON::mesh_type mt,
