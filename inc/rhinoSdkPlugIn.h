...
public:
  ...
  //    command.
  ON_DEPRECATED BOOL32 MakeReferenceTableName(const wchar_t* lpsName, ON_wString& new_name) const;
  
  BOOL32 MakeReferenceTableName(const CRhinoDoc& doc, const wchar_t* lpsName, ON_wString& new_name) const;
