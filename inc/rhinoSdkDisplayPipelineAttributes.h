...
public:
  ...
  ON_DEPRECATED_MSG("use CDisplayPipelineAttributes::SetPipelineId")
  void                  SetPipeline(const ON_ClassId*);

  void                  SetPipelineId(const ON_UUID&);
  ...
  // Description:
  //  Sets the quality of the dynamcic range that the pipeline should use for its
  //  frame buffer.
  // Parameters:
  //  quality: [in]
  //     0 - Standard Dynamic Range (SDR)
  //     1 - High Dynamic Range low precision (HDR_FP16)
