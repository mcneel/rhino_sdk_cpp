...
public:
  ...
  CRhinoGumballFrame(const CRhinoGumballFrame& src);
  const CRhinoGumballFrame& operator=(const CRhinoGumballFrame& src);

  CRhinoGumballFrame(CRhinoGumballFrame&&);
  CRhinoGumballFrame& operator=(CRhinoGumballFrame&&);
  ...
  */
  ...
  bool SetUvnDirections(
    const ON_3dVector& vEast,
    const ON_3dVector& vWest,
    const ON_3dVector& vNorth,
    const ON_3dVector& vSouth,
    const ON_3dVector& vNormal
  );

  void GetUvnDirections(
    ON_3dVector& vEastOut,
    ON_3dVector& vWestOut,
    ON_3dVector& vNorthOut,
    ON_3dVector& vSouthOut,
    ON_3dVector& vNormalOut
  ) const;
  ...
  */
  ...
  bool TryGetUvnLine(GUMBALL_MODE uvnMode, ON_Line& lOut) const;
...
private:
  std::unique_ptr<class CRhinoGumballFramePrivate> m_private;
};
...
public:
  ...
  CRhinoGumballAppearance(const CRhinoGumballAppearance& src);
  const CRhinoGumballAppearance& operator=(const CRhinoGumballAppearance& src);

  CRhinoGumballAppearance(CRhinoGumballAppearance&&);
  CRhinoGumballAppearance& operator=(CRhinoGumballAppearance&&);
...
public:
    void SetIsUvnGumball(bool bUvn);
    bool IsUvnGumball() const;

private:
  std::unique_ptr<class CRhinoGumballAppearancePrivate> m_private;
};
