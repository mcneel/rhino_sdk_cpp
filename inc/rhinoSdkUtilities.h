...
Parameters:
  curve_count [in] number of input curves
  tolerance   [in] tolerance used to sort curves
  pCrvs       [in] Array of pointers to input curves
  edgeSrf     [out] The resulting Coons patch surface
  feedback    [out] Any feedback to show the user
Returns:
  boolean to indicate success or failure
*/
RHINO_SDK_FUNCTION
bool RhinoCreateEdgeSrf(
  int curve_count,
  double tolerance,
  const ON_Curve** pCrvs,
  ON_NurbsSurface& edgeSrf,
  ON_wString& feedback
);
...
/*
Description:
  Read hatch pattern definitions from all .pat files in a specified folder.
Parameters:
  pFolder       - [in] name of an existing folder.
  hatchPatterns - [in/out] hatch patterns are appended to this list.
Returns:
  >= 0 if success.
*/
RHINO_SDK_FUNCTION
int RhinoReadHatchPatternFolder(
  const wchar_t* pFolder,
  ON_ObjectArray<ON_HatchPattern>& hatchPatterns
);

/*
Description:
  Read hatch pattern definitions from all .pat files in Rhino's hatch pattern folder.
Parameters:
  hatchPatterns - [in/out] hatch patterns are appended to this list.
Returns:
  >= 0 if success.
*/
RHINO_SDK_FUNCTION
int RhinoReadSystemHatchPatterns(
  ON_ObjectArray<ON_HatchPattern>& hatchPatterns
);
...
/*
Description:
  Reads section styles from the section style table in the specified .3dm file.
Parameters:
  filename       - [in] Name of existing .3dm file.
  section_styles - [in/out] Section style are appended to this list.
  hatch_patterns - [in/out] Hatch patterns, indexed to section styles, are appended to this list.
Returns:
  true if success, false otherwise.
*/
RHINO_SDK_FUNCTION
bool RhinoReadSectionStylesFromFile(
  const wchar_t* filename,
  ON_ObjectArray<ON_SectionStyle>& section_styles,
  ON_ObjectArray<ON_HatchPattern>& hatch_patterns
);
...
Parameters:
  Refs to the SubDs to compare
Returns:
  1 or -1 if the SubDs are different
  0 if they are the same
Notes:
  This is a fast compare function that can be used for sorting
*/
RHINO_SDK_FUNCTION
int Rhino_dup_cmp_subd(const ON_SubD& subDa, const ON_SubD& subDb);
...
/*
Description:
  Splits a curve into pieces using an intersecting plane.
Parameters:
  curve      - [in] Curve to split.
  plane      - [in] Intersecting plane.
  tolerance  - [in] intersection tolerance
  angtolrads - [in] angle tolerance in radians
  pieces     - [out] Curves of all the split components.
Returns:
...
Returns:
  The number of curves added to OutCurves if successful, 0 otherwise.
Remarks:
  1. THE CALLER IS RESPONSIBLE FOR DESTROYING THE OUTPUT CURVES.
  2. This function does NOT behave the same as the Explode command. 
     Use RhinoGetSubCurves for if you want the same code path as the Explode command.
     Among other things, RhinoGetSubCurves uses ON::continuity::Gsmooth_continuous, while
     RhinoDuplicateCurveSegments uses ON::continuity::G1_continuous.
*/
RHINO_SDK_FUNCTION
...
public:
  ...
  Parameters:
    ...
    bool setback_fillets  [in] -  Use setback fillets (not used for blend_type CRhinoFilletEdge::BlendType::Chamfer)
  ...
  */
  ...
  Remarks:
    CRITICAL: Memory for the resulting Breps is allocated. It is the calling functions responsibility to clean up the memory.
  */
  ON_DEPRECATED_MSG("Prefer the version that takes a setback_fillets option.")
...
/*
WARNING: DEPRECATED. Use one of the new  RhinoCreate*FilletSrfToRail
Description:
...
/*
WARNING: DEPRECATED. Use one of the new RhinoCreate*FilletSrfCrv functions.
Description:
...
/*
Description: Continue making fillets/chamfers across multiple tangent faces.
  This method expects one single untrimmed fillet/chamfer created for FaceA and FaceB in the Fillets array. 
  This fillet surface is used to find adjacent tangent faces to FaceA and FaceB and add them to the Fillets array.
  Any trimmed results in resultA and resultsB are discarded on input. If trims need to be made they will be made
...
*/
RHINO_SDK_FUNCTION bool RhinoContinueFilletsAcrossTangentFaces
(
  const ON_BrepFace& FaceA, double radius0,
  const ON_BrepFace& FaceB, double radius1,
  bool trim, bool extend, double tolerance, double angleToleranceRadians, 
  int method, int degree, double tanSlider, double innerSlider,
  ON_SimpleArray<ON_Brep*>& Fillets, ON_SimpleArray<ON_Brep*>& resultsA, ON_SimpleArray<ON_Brep*>& resultsB
);
...
Parameters :
  ...
  Remarks : You may want to use RhinoSplitFacesAtTangents and/or ON_Brep::SplitKinkyFaces prior to creating fillets
  */
RHINO_SDK_FUNCTION bool RhinoCreateChamferSrf(const ON_BrepFace& FaceA, const ON_2dPoint& uvA,
  const ON_BrepFace& FaceB, const ON_2dPoint& uvB, double radius0, double radius1, double tolerance,
  ON_SimpleArray<ON_Brep*>& resultsA, ON_SimpleArray<ON_Brep*>& resultsB,
  int rail_degree, bool bTrim, bool bExtend, ON_SimpleArray<ON_Brep*>& Chamfers);
...
Parameters :
  ...
  Remarks : You may want to use RhinoSplitFacesAtTangents and/or ON_Brep::SplitKinkyFaces prior to creating fillets
  */
RHINO_SDK_FUNCTION bool RhinoCreateRationalArcsFilletSrfCrv(const ON_BrepFace& Face, const ON_2dPoint& uv,
  const ON_Curve& Curve, double t, double radius, double tolerance, ON_SimpleArray<ON_Brep*>& results,
  int rail_degree, bool bTrim, bool bExtend, ON_SimpleArray<ON_Brep*>& Fillets);
...
Parameters :
  ...
  Remarks : You may want to use RhinoSplitFacesAtTangents and/or ON_Brep::SplitKinkyFaces prior to creating fillets
  */
RHINO_SDK_FUNCTION bool RhinoCreateNonRationalQuinticArcsFilletSrfCrv(const ON_BrepFace& Face, const ON_2dPoint& uv,
  const ON_Curve& Curve, double t, double radius, double tolerance, ON_SimpleArray<ON_Brep*>& results,
  int rail_degree, bool bTrim, bool bExtend, ON_SimpleArray<ON_Brep*>& Fillets);
...
Parameters :
  ...
  Remarks : You may want to use RhinoSplitFacesAtTangents and/or ON_Brep::SplitKinkyFaces prior to creating fillets
  */
RHINO_SDK_FUNCTION bool RhinoCreateNonRationalQuinticFilletSrfCrv(const ON_BrepFace& Face, const ON_2dPoint& uv,
  const ON_Curve& Curve, double t, double radius, double tolerance,
  ON_SimpleArray<ON_Brep*>& results, int rail_degree, double TanSlider, double InnerSlider, bool bTrim,
  bool bExtend, ON_SimpleArray<ON_Brep*>& Fillets);
...
Parameters :
  ...
  Remarks : You may want to use RhinoSplitFacesAtTangents and/or ON_Brep::SplitKinkyFaces prior to creating fillets
  */
RHINO_SDK_FUNCTION bool RhinoCreateNonRationalQuarticArcsFilletSrfCrv(const ON_BrepFace& Face, const ON_2dPoint& uv,
  const ON_Curve& Curve, double t, double radius, double tolerance, ON_SimpleArray<ON_Brep*>& results,
  int rail_degree, bool bTrim, bool bExtend, ON_SimpleArray<ON_Brep*>& Fillets);
...
Parameters :
  ...
  Remarks : You may want to use RhinoSplitFacesAtTangents and/or ON_Brep::SplitKinkyFaces prior to creating fillets
  */
RHINO_SDK_FUNCTION bool RhinoCreateNonRationalQuarticFilletSrfCrv(const ON_BrepFace& Face, const ON_2dPoint& uv,
  const ON_Curve& Curve, double t, double radius, double tolerance,
  ON_SimpleArray<ON_Brep*>& results, int rail_degree, double TanSlider, double InnerSlider,
  bool bTrim, bool bExtend, ON_SimpleArray<ON_Brep*>& Fillets);
...
Parameters :
  ...
  Remarks : You may want to use RhinoSplitFacesAtTangents and/or ON_Brep::SplitKinkyFaces prior to creating fillets
  */
RHINO_SDK_FUNCTION bool RhinoCreateNonRationalCubicArcsFilletSrfCrv(const ON_BrepFace& Face, const ON_2dPoint& uv,
  const ON_Curve& Curve, double t, double radius, double tolerance,
  ON_SimpleArray<ON_Brep*>& results, int rail_degree, bool bTrim,
  bool bExtend, ON_SimpleArray<ON_Brep*>& Fillets);
...
Parameters :
  ...
  Remarks : You may want to use RhinoSplitFacesAtTangents and/or ON_Brep::SplitKinkyFaces prior to creating fillets
  */
RHINO_SDK_FUNCTION bool RhinoCreateNonRationalCubicFilletSrfCrv(const ON_BrepFace& Face, const ON_2dPoint& uv,
  const ON_Curve& Curve, double t, double radius, double tolerance,
  ON_SimpleArray<ON_Brep*>& results,
  int rail_degree, double TanSlider, bool bTrim, bool bExtend, ON_SimpleArray<ON_Brep*>& Fillets);
...
Parameters :
  ...
  Remarks : You may want to use RhinoSplitFacesAtTangents and/or ON_Brep::SplitKinkyFaces prior to creating fillets
  */
RHINO_SDK_FUNCTION bool RhinoCreateG2ChordalQuinticFilletSrfCrv(const ON_BrepFace& Face, const ON_2dPoint& uv,
  const ON_Curve& Curve, double t, double radius, double tolerance,
  ON_SimpleArray<ON_Brep*>& results, int rail_degree, bool bTrim, bool bExtend, ON_SimpleArray<ON_Brep*>& Fillets);
...
Parameters :
  ...
  Remarks : You may want to use RhinoSplitFacesAtTangents and/or ON_Brep::SplitKinkyFaces prior to creating fillets
  */
RHINO_SDK_FUNCTION bool RhinoCreateRationalArcsFilletSrfToRail(const ON_BrepFace& RailFace, const ON_BrepFace& Face,
  const ON_2dPoint& uv, const ON_Curve& Rail, double tolerance, ON_SimpleArray<ON_Brep*>& resultsRailFace, ON_SimpleArray<ON_Brep*>& resultsFace,
  int rail_degree, bool bTrim, bool bExtend, ON_SimpleArray<ON_Brep*>& Fillets);
...
Parameters :
  ...
  Remarks : You may want to use RhinoSplitFacesAtTangents and/or ON_Brep::SplitKinkyFaces prior to creating fillets
  */
RHINO_SDK_FUNCTION bool RhinoCreateNonRationalQuinticArcsFilletSrfToRail(const ON_BrepFace& RailFace, const ON_BrepFace& Face,
  const ON_2dPoint& uv, const ON_Curve& Rail, double tolerance, ON_SimpleArray<ON_Brep*>& resultsRailFace, ON_SimpleArray<ON_Brep*>& resultsFace,
  int rail_degree, bool bTrim, bool bExtend, ON_SimpleArray<ON_Brep*>& Fillets);
...
Parameters :
  ...
  Remarks : You may want to use RhinoSplitFacesAtTangents and/or ON_Brep::SplitKinkyFaces prior to creating fillets
  */
RHINO_SDK_FUNCTION bool RhinoCreateNonRationalQuinticFilletSrfToRail(const ON_BrepFace& RailFace, const ON_BrepFace& Face,
  const ON_2dPoint& uv, const ON_Curve& Rail, double tolerance, ON_SimpleArray<ON_Brep*>& resultsRailFace, ON_SimpleArray<ON_Brep*>& resultsFace,
  int rail_degree, double TanSlider, double InnerSlider, bool bTrim, bool bExtend, ON_SimpleArray<ON_Brep*>& Fillets);
...
Parameters :
  ...
  Remarks : You may want to use RhinoSplitFacesAtTangents and/or ON_Brep::SplitKinkyFaces prior to creating fillets
  */
RHINO_SDK_FUNCTION bool RhinoCreateNonRationalQuarticArcsFilletSrfToRail(const ON_BrepFace& RailFace, const ON_BrepFace& Face,
  const ON_2dPoint& uv, const ON_Curve& Rail, double tolerance, ON_SimpleArray<ON_Brep*>& resultsRailFace, ON_SimpleArray<ON_Brep*>& resultsFace,
  int rail_degree, bool bTrim, bool bExtend, ON_SimpleArray<ON_Brep*>& Fillets);
...
Parameters :
  ...
  Remarks : You may want to use RhinoSplitFacesAtTangents and/or ON_Brep::SplitKinkyFaces prior to creating fillets
  */
RHINO_SDK_FUNCTION bool RhinoCreateNonRationalQuarticFilletSrfToRail(const ON_BrepFace& RailFace, const ON_BrepFace& Face,
  const ON_2dPoint& uv, const ON_Curve& Rail, double tolerance, ON_SimpleArray<ON_Brep*>& resultsRailFace, ON_SimpleArray<ON_Brep*>& resultsFace,
  int rail_degree, double TanSlider, double InnerSlider, bool bTrim, bool bExtend, ON_SimpleArray<ON_Brep*>& Fillets);
...
Parameters :
  ...
  Remarks : You may want to use RhinoSplitFacesAtTangents and/or ON_Brep::SplitKinkyFaces prior to creating fillets
  */
RHINO_SDK_FUNCTION bool RhinoCreateNonRationalCubicArcsFilletSrfToRail(const ON_BrepFace& RailFace, const ON_BrepFace& Face,
  const ON_2dPoint& uv, const ON_Curve& Rail, double tolerance, ON_SimpleArray<ON_Brep*>& resultsRailFace, ON_SimpleArray<ON_Brep*>& resultsFace,
  int rail_degree, bool bTrim, bool bExtend, ON_SimpleArray<ON_Brep*>& Fillets);
...
Parameters :
  ...
  Remarks : You may want to use RhinoSplitFacesAtTangents and/or ON_Brep::SplitKinkyFaces prior to creating fillets
  */
RHINO_SDK_FUNCTION bool RhinoCreateNonRationalCubicFilletSrfToRail(const ON_BrepFace& RailFace, const ON_BrepFace& Face,
  const ON_2dPoint& uv, const ON_Curve& Rail, double tolerance, ON_SimpleArray<ON_Brep*>& resultsRailFace, ON_SimpleArray<ON_Brep*>& resultsFace,
  int rail_degree, double TanSlider, bool bTrim, bool bExtend, ON_SimpleArray<ON_Brep*>& Fillets);
...
Parameters :
  ...
  Remarks : You may want to use RhinoSplitFacesAtTangents and/or ON_Brep::SplitKinkyFaces prior to creating fillets
  */
RHINO_SDK_FUNCTION bool RhinoCreateG2ChordalQuinticFilletSrfToRail(const ON_BrepFace& RailFace, const ON_BrepFace& Face,
  const ON_2dPoint& uv, const ON_Curve& Rail, double tolerance, ON_SimpleArray<ON_Brep*>& resultsRailFace, ON_SimpleArray<ON_Brep*>& resultsFace,
  int rail_degree, bool bTrim, bool bExtend, ON_SimpleArray<ON_Brep*>& Fillets);
...
Parameters:
  brep            - [in/out] The Brep.
  bAggressiveMode - [in] if true, all curuvature discontinuities with constant tangents will be split.
                         if false, only split when the curvature change is from no curvature to some curvature or when the curvature vector directions are opposite.
Returns:
  True if successful, false otherwise.
*/
RHINO_SDK_FUNCTION
bool RhinoSplitFacesAtTangents(ON_Brep& brep, bool bAggressiveMode);
...
*/
RHINO_SDK_FUNCTION
bool RhinoSplitFaceAtTangents(ON_Brep& brep, int face_index, bool bAggressiveMode);
...
public:
  ...
  CRhinoSurfaceFillet(const ON_BrepFace& FaceA, const ON_2dPoint& uvA,
    const ON_BrepFace& FaceB, const ON_2dPoint& uvB,
    double radius0, double radius1, bool bAllowExtend, double tolerance);
  ...
  bool Lines(int rail_degree, bool bExtend, ON_SimpleArray<ON_Brep*>& Fillets);
  ...
  bool ChangeRadius(double new_radius0, double new_radius1);
...
#pragma region RH_C_SHARED_ENUM [RhinoVariationalDomain] [Rhino.Geometry.RhinoVariationalDomain] [int]
/// <summary>
/// The type of trimming domain 
/// </summary>
enum class RhinoVariationalDomain : int
{
  /// <summary>
...
class RHINO_SDK_CLASS CRhinoVarSrfConstraintPoint
{
public:
  CRhinoVarSrfConstraintPoint(const ON_3dPoint& point);

  const ON_3dPoint& Point() const { return m_point; }
private:
  const ON_3dPoint m_point;
};

class RHINO_SDK_CLASS CRhinoVarSrfConstraintNormal
{
public:
  CRhinoVarSrfConstraintNormal(const ON_Line& normal);

  const ON_Line Normal() const { return m_normal; }
private:
  const ON_Line m_normal;
};

class RHINO_SDK_CLASS CRhinoVarSrfConstraintCurve
{
public:
  ...
  virtual std::shared_ptr<CRhinoVarSrfConstraintCurve> Duplicate(const ON_Xform* xform = nullptr);
  ...
  // commmand can change these continuities
...
protected:  
  bool m_reversed;
  // any geometry that was created when this curve was created (e.g. by .Duplicate()) 
  // that needs to stay alive and be deleted when this object goes out of scope.
  ON_SimpleArray<const ON_Geometry*> m_geos;
  const ON_Curve* m_curve;
};


class RHINO_SDK_CLASS CRhinoVarSrfEdgeCurve : public CRhinoVarSrfConstraintCurve
{
public:
...
class RHINO_SDK_CLASS CRhinoVarSrfSettings
{
public:
  
  CRhinoVarSrfSettings(double tolerance, double angleToleranceRadians, 
  ...
  // surface degrees
  int m_degreeU = 5, m_degreeV = 5;

  // surface span counts. See the implementation of CvCounts
  // for details on how span counts are used to calculate
  // cv counts at degrees > 3
  int m_spanCountU = 1, m_spanCountV = 1;
  ...
  // amounts of stretching, bending and rocBending applied.
  // these are normalized to the sum of the three
  double m_stretching = 0, m_bending = 0, m_rocBending = 1;
  ...
  // this is the continuity chosen by the user during the command.
  // during generation of the surfac, each curve has its own continuity
  int m_continuity = 1;
  ...
  const ON_Surface* m_initialSurface = nullptr;

  // if an initial surface is set, preserve the edges by not changing the boundary control points.
  bool m_preserveEdges = false;

private:
  // allow for future extension without changing the class size
  class CRhVarSrfSettingsPrivate* m_private = nullptr;
};

class RHINO_SDK_CLASS CRhinoVarSrfResult
{
public:
  CRhinoVarSrfResult();
  ...
  // true if internal G0 constraints
  bool m_internalToleranceMet = false;

  // true if edge G0 constraints are met
  bool m_toleranceMet = false;

  // true if edge G1 constraints are met
  bool m_angleToleranceMet = false;

  // true if edge G2 constraints are met
  bool m_curvatureToleranceMet = false;

  // warnings to the user
  ON_wString m_warning;
...
(
  const ON_ClassArray<std::shared_ptr<CRhinoVarSrfConstraintCurve>>& edges,
...
/*
Description
Generate section curves by intersecting a plane with an object
of type Brep, Extrusion, SubD , Mesh or Block Instance.

Parameters:
[in] object - object to section
[in] plane - Intersecting plane
[in] name - name for the section objects
[in] join - join and simplify section curves.
[in] tol - tolerance
[out] outGeometry - sections curves
[out] outAttributes - Section curves attributes (from input object, or peices in a block)
[in] geometryFromSolids - List of flages to indicate if the section curve comes from a solid object
...
RHINO_SDK_FUNCTION
bool RhinoCreateSections(
  const CRhinoObject* object,
  const ON_Plane& plane,
  const wchar_t* name,
  bool bJoin,
  double tol,
  ON_ClassArray<ON_SimpleArray<ON_Geometry*>>& outGeometry,
  ON_ClassArray<ON_3dmObjectAttributes>& outAttributes,
  ON_SimpleArray<bool>& geometryFromSolids
);

/*
Description
Generate slices by intersecting a plane with an object
of type Brep, Extrusion, SubD , Mesh or Block Instance.
...
[in] plane - Intersecting plane
[in] name - name for the section objects
[int] thickness - thickness of the slice. If thickness is less than tolerance,
                  a surface will be created instead of a solid slice.
[in] tol - tolerance
[out] outGeometry - slices geometry (breps, extrusions, meshes, curves)
[out] outAttributes - slices attributes (from input object, or peices in a block)
...
RHINO_SDK_FUNCTION
bool RhinoCreateSlices(
  const CRhinoObject* object,
  const ON_Plane& centerPlane,
  const wchar_t* name,
  double thickness,
  double tol,
  ON_SimpleArray<ON_Geometry*>& outGeometry,
  ON_ClassArray<ON_3dmObjectAttributes>& outAttributes
);
...
/*
Description
Generate a catenary curve through point.

Parameters:
[in] catenary_start - catenary start point
[in] catenary_end - catenary end point
[in] axis_dir - catenary axis/gravity direction
[in] through_point - point on the catenary between catenary_start and catenary_end
[in] bSmooth = if false generates polyline output
[in] point_count - number of points in the output curve
[out] apex_out - apex point of the output catenary curve
[out] parameter_out - output catenary parameter "a" in the formula y = a * cosh(x/a)
[out] length_out - output catenary length
[out] max_deviation_out - 1

Returns:
curve if successful
*/
RHINO_SDK_FUNCTION
ON_Curve* RhinoCatenaryThroughPoint(
  const ON_3dPoint catenary_start,
  const ON_3dPoint catenary_end,
  const ON_3dVector axis_dir,
  const ON_3dPoint through_point,
  const bool bSmooth = true,
  const int point_count = 20,
  ON_3dPoint* apex_out = nullptr,
...
[in] catenary_end - catenary end point
[in] axis_dir - catenary axis/gravity direction
[in] catenary_length - the desired catenary length
[in] bSmooth = if false generates polyline output
[in] point_count - number of points in the output curve
[out] apex_out - apex point of the output catenary curve
[out] parameter_out - output catenary parameter "a" in the formula y = a * cosh(x/a)
[out] length_out - output catenary length
[out] max_deviation_out - sampled max deviation between the output curve and the analytic catenary

Returns:
curve if successful
*/
RHINO_SDK_FUNCTION
ON_Curve* RhinoCatenaryFromLength(
  const ON_3dPoint catenary_start,
  const ON_3dPoint catenary_end,
  const ON_3dVector axis_dir,
...
[in] catenary_end - catenary end point
[in] axis_dir - catenary axis/gravity direction
[in] catenary_parameter - catenary parameter
[in] bSmooth = if false generates polyline output
[in] point_count - number of points in the output curve
[out] apex_out - apex point of the output catenary curve
[out] parameter_out - output catenary parameter "a" in the formula y = a * cosh(x/a)
...
*/
RHINO_SDK_FUNCTION
ON_Curve* RhinoCatenaryFromParameter(
  const ON_3dPoint catenary_start,
  const ON_3dPoint catenary_end,
  const ON_3dVector axis_dir,
...
[in] catenary_end - catenary end point
[in] axis_dir - catenary axis/gravity direction
[in] catenary_apex - desired catenary apex point
[in] bSmooth = if false generates polyline output
[in] point_count - number of points in the output curve
[out] apex_out - apex point of the output catenary curve
[out] parameter_out - output catenary parameter "a" in the formula y = a * cosh(x/a)
...
*/
RHINO_SDK_FUNCTION
ON_Curve* RhinoCatenaryFromApex(
  const ON_3dPoint catenary_start,
  const ON_3dPoint catenary_end,
  const ON_3dVector axis_dir,
  const ON_3dPoint catenary_apex,
  const bool bSmooth = true,
  const int point_count = 20,
  ON_3dPoint* apex_out = nullptr,
  double* parameter_out = nullptr,
