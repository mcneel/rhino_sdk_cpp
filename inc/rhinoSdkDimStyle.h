...
private:
  ...
  CRhinoDimStyle* m_DefaultModelUnitsGeometricTolerance = nullptr;
...
private:
  ON__UINT_PTR m_reserved_ptr[982] = {};
...
public:
  // Rhino 9 new default dimension styles
  const CRhinoDimStyle& DefaultModelUnitsGeometricTolerance;    // index = -13;

  enum : unsigned int
  {
    DefaultDimStyleCount = 13
  };
